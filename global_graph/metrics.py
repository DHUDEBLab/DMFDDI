...
def get_roc_score(model,
    ...
    # print("AAAAA1", edges_pos)
    # print("BB", type(edges_pos))
    # print("AAAAA2", edges_neg)
    # print("BB", type(edges_neg))
    # print("AAAAA3", adj_rec)
    # print("BB", type(adj_rec))
    # print("BBBBB", edges_neg)
    # print("CCCCC", adj_rec)
    # print(preds)
