...
def parse_args():
    ...
    # data
    parser.add_argument('--data_path', type=str, default='datachem/DeepDDI_train.csv', choices=['datachem/ZhangDDI_train.csv', 'datachem/ChChMiner_train.csv', 'datachem/DeepDDI_train.csv'])
    parser.add_argument('--separate_val_path', type=str, default='datachem/DeepDDI_valid.csv', choices=['datachem/ZhangDDI_valid.csv', 'datachem/ChChMiner_valid.csv', 'datachem/DeepDDI_valid.csv'])
    parser.add_argument('--separate_test_path', type=str, default='datachem/DeepDDI_test.csv', choices=['datachem/ZhangDDI_test.csv', 'datachem/ChChMiner_test.csv', 'datachem/DeepDDI_test.csv'])
    parser.add_argument('--vocab_path', type=str, default='datachem/drug_list_deep.csv', choices=['datachem/drug_list_deep.csv', 'datachem/drug_list_miner.csv', 'datachem/drug_list_deep.csv'])
